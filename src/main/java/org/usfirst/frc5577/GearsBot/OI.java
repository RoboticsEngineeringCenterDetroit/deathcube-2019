...
public class OI {
	...
	public OI() {
		...
		// Button rBumperManipulator = new JoystickButton(manipulatorController,
		// R_BUMPER);
		...
		// Button dPadUp = new JoystickButton(manipulatorCont,
		// manipulatorCont.getPOV(0));
		// Button dPadDown = new JoystickButton(manipulatorCont,
		// manipulatorCont.getPOV(180));
		buttons.add(aButton);
		buttons.add(bButton);
		buttons.add(xButton);
		buttons.add(yButton);
